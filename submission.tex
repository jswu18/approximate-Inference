...
\newpage
The Python code for an abstract binary latent factor model approximation:
\lstinputlisting[language=Python]{src/models/binary_latent_factor_model_approximation.py}
